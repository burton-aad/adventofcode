...
if __name__=="__main__":
    parser = argparse.ArgumentParser(description='AoC 2017 - Jour 03')
    parser.add_argument("start", nargs='?', type=int, help="Start square", default=368078)
    args = parser.parse_args()

    print("Part 1: ", get_1_dist(args.start))
    print("Part 2: ", get_2_val(args.start))
